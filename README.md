...
The repository is based on the [example Jupyter app](https://github.com/OSC/bc_example_jupyter) (provided by OSC) and [ood-jupyterlab-spack-mamba](https://github.com/Harvard-ATG/ood-jupyterlab-spack-mamba).
